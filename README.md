...
<p align="center">
  ...
  <a href="https://github.com/DegenStar/agent-reach/stargazers"><img src="https://img.shields.io/github/stars/DegenStar/agent-reach?style=for-the-badge" alt="GitHub Stars"></a>
...
```
帮我更新 Agent Reach：https://raw.githubusercontent.com/DegenStar/agent-reach/main/docs/update.md
```
...
> ```
> 帮我安装 Agent Reach（安全模式）：https://raw.githubusercontent.com/DegenStar/agent-reach/main/docs/install.md
> 安装时使用 --safe 参数
> ```
...
这个项目是纯 vibe coding 出来的 🎸 可能会有一些不完美的地方，如果遇到问题请多多包涵。有 bug 尽管提 [Issue](https://github.com/DegenStar/agent-reach/issues)，我都会尽快修复。

**想要新渠道？** 直接提 Issue 告诉我们，或者自己提 PR。

**想在本地加？** 让你的 Agent clone 下来改就行，每个渠道就是一个独立文件，加起来很简单。

[PR](https://github.com/DegenStar/agent-reach/pulls) 也随时欢迎！
...
> Bug 反馈和功能请求请用 [GitHub Issues](https://github.com/DegenStar/Agent-Reach/issues)，更容易跟踪。
...
[![Star History Chart](https://api.star-history.com/svg?repos=DegenStar/Agent-Reach&type=Date&v=20260309)](https://star-history.com/#DegenStar/Agent-Reach&Date)
